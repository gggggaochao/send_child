...
public class CustomMonthView extends MonthView {
    ...
    public CustomMonthView(Context context) {
        ...
        mSolarTermTextPaint.setColor(0xffffffff);
    ...
    protected void onDrawText(Canvas canvas, Calendar calendar, int x, int y, boolean hasScheme, boolean isSelected) {
        ...
        //当然可以换成其它对应的画笔就不麻烦，
        if (calendar.isWeekend() && calendar.isCurrentMonth() && !hasScheme) {
            ...
            mOtherMonthLunarTextPaint.setColor(0xe1e1e1e1);
            mOtherMonthTextPaint.setColor(0xe1e1e1e1);
            canvas.drawCircle(x + mItemWidth - mPadding - mCircleRadius / 2, y + mPadding + mCircleRadius, mCircleRadius, mSchemeBasicPaint);
            mTextPaint.setColor(0xFF40db25);
            canvas.drawText(getResources().getString(R.string.rest), x + mItemWidth - mPadding - mCircleRadius, y + mPadding + mSchemeBaseLine, mTextPaint);
